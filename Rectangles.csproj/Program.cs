    ...
    internal static class Program
    {
        ...
        private static IEnumerable<TestCase> CreateTestCases()
        {
            ...
            yield return new RectanglesTestRoomTestCase(new Rectangle(24, -34, 24, 21), new Rectangle(29, -29, 0, 57),
                true, 0, -1); //
            yield return new RectanglesTestRoomTestCase(new Rectangle(20, 2, 40, 4), new Rectangle(20, 2, 40, 4),
                true, 160, 1); //
            yield return new RectanglesTestRoomTestCase(new Rectangle(10, 2, 10, 0), new Rectangle(20, 2, 40, 4),
                true, 0, -1); //
            yield return new RectanglesTestRoomTestCase(new Rectangle(20, 2, 40, 4), new Rectangle(20, 3, 0, 1),
                true, 0, 1); //
            yield return new RectanglesTestRoomTestCase(new Rectangle(20, 2, 40, 4), new Rectangle(20, 2, 0, 1),
                true, 0, 1); //
            yield return new RectanglesTestRoomTestCase(new Rectangle(20, 2, 40, 4), new Rectangle(10, 3, 10, 0),
                true, 0, -1); //
